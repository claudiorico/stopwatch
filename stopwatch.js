...
startBtn.addEventListener('click', () => { sw1.start(updateDisplay) });
stopBtn.addEventListener('click', () => { sw1.stop(updateDisplay) });
resetBtn.addEventListener('click', () => { sw1.restart(updateDisplay) });
